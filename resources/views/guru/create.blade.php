                    ...
                    <div class="card-body">
                        <form action="{{ route('guru.store') }}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="alamat" id="alamat" rows="3" placeholder="Masukkan Alamat">{{ old('alamat') }}</textarea>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="bidang_mengajar" class="form-control" id="bidang_mengajar" placeholder="Masukkan Bidang Mengajar" value="{{ old('bidang_mengajar') }}">
                            </div>
